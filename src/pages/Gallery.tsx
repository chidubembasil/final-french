import { Camera, Grid3X3, List, ZoomIn, ChevronRight, ChevronLeft, PlayCircle, Loader2, Image as ImageIcon, X } from "lucide-react";
...
function Gallery() {
  ...
  return (
    <main className="pt-20 bg-gray-50/30 min-h-screen relative">
      {/* Dynamic Hero Section - REVERTED TO ORIGINAL STYLE */}
      <div className="relative w-full h-[90dvh] overflow-hidden bg-slate-900">
        {loadingHero ? (
          ...
          <>
            ...
            />
            {/* Reverted to your original blue/red gradient */}
                  ...
                  {CATEGORIES.map((cat) => (
                    <button
                      ...
                      className={`px-5 py-2 rounded-full text-xs font-medium transition-all whitespace-nowrap ${
                        activeCategory === cat ? "bg-blue-600 text-white shadow-md" : "bg-gray-100 text-gray-600 hover:bg-gray-200" 
                      }`}
                    >
                      {cat}
                    </button>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/95 backdrop-blur-lg p-4 transition-all">
          ...
          <div className="max-w-5xl w-full flex flex-col gap-6 items-center">
            ...
            <div className="text-center text-white max-w-2xl">
              ...
              <div className="mt-4 inline-block px-4 py-1 bg-blue-600 rounded-full text-[10px] font-black uppercase tracking-widest">
