import { Newspaper, Search, Loader2, X, Calendar, MapPin, ChevronLeft, ChevronRight, ArrowLeft } from "lucide-react";
      ...
      {selectedPost && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/90 backdrop-blur-md p-4 overflow-y-auto">
          <div className="relative bg-white w-full max-w-4xl rounded-[3rem] overflow-hidden shadow-2xl my-auto">
            ...
            <button onClick={() => setSelectedPost(null)} className="absolute top-6 left-6 z-10 flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors group">
