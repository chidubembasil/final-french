...
export default function ResourceHero() {
  ...
  return (
    <main className="w-full py-6 flex items-center justify-center bg-[#fcfaf8]" id="resource">
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <h2 className="font-serif text-4xl text-center font-bold text-slate-900">
          Teaching Resources
        </h2>
        <div className="w-24 h-1 bg-blue-700 rounded-full mt-1"></div>
        <p className="text-gray-500 text-lg leading-relaxed max-w-xl mt-2 mb-4">
