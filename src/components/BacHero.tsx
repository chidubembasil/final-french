    ...
    <section className="py-7 bg-[#fcfaf8]" id="bac">
      ...
      <div  className="w-full flex justify-center items-center mt-3">
        <button 
          ...
          className="group relative bg-blue-700 hover:bg-blue-800 text-white px-8 py-3 rounded-2xl font-bold text-lg shadow-xl shadow-red-100 transition-all active:scale-95 flex items-center gap-3"
        >
          Explore
